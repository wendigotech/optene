                            ...
                            el(Panel, {},
                                el(PanelBody, {
                                    ...
                                    el(BaseControl, {
                                        ...
                                        el(RichText, {
                                            value: props.attributes.service_label,
                                            style: {
                                                    border: '1px solid black',
                                                    padding: '6px 8px',
                                                    minHeight: '80px',
                                            ...
                                            onChange: function(val) { setAttributes({service_label: val}) },
                                        })
                                    ]),
                                    el(TextControl, {
                                        value: props.attributes.service_options,
                                        help: __( '' ),
                                        label: __( 'Source Options' ),
                                        onChange: function(val) { setAttributes({service_options: val}) },
                                        type: 'text'
                                    }),
                                    el(BaseControl, {
                                        help: __( '' ),
